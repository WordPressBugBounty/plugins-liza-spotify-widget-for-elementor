    ...
    protected function render_track($track_data) {
        ...
        <div class="track-info">
            <div class="track-artwork">
                <?php
                $image_url = esc_url($item['album']['images'][0]['url']);
                $image_alt = esc_attr($item['name']);
            ...
            <div class="track-details">
                ...
                <a href="<?php echo esc_url($item['external_urls']['spotify']); ?>" target="_blank" class="listen-now">
                    ...
                    <?php
                    /* translators: Button text for listening to track on Spotify */
                    esc_html_e('Listen Now', 'liza-spotify-widget-for-elementor');
                    ?>
                </a>
            </div>
        </div>
