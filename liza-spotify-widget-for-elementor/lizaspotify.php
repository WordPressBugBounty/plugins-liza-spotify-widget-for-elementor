...
define('LIZA_SPOTIFY_VERSION', '2.3');  
...
class LizaSpotify {
    ...
    private function load_dependencies() {
        ...
        require_once LIZA_SPOTIFY_PATH . 'includes/Ajax/Search.php';
    }
    ...
    public function enqueue_styles() {
        ...
        wp_enqueue_style(
            'liza-spotify-embed',
            LIZA_SPOTIFY_URL . 'assets/css/spotify-embed.css',
            [],
            LIZA_SPOTIFY_VERSION
        );
    }
    ...
    public function enqueue_editor_scripts() {
        wp_enqueue_script(
            'spotify-embed',
            LIZA_SPOTIFY_URL . 'assets/js/spotify-embed.js',
            ['jquery'],
            LIZA_SPOTIFY_VERSION,
            true
        );
        ...
        wp_localize_script('spotify-embed', 'spotifyConfig', [
            'clientId' => get_option('liza_spotify_client_id'),
            'clientSecret' => get_option('liza_spotify_client_secret'),
            'i18n' => [
                'searching' => __('Searching...', 'liza-spotify'),
                'error' => __('Error searching Spotify. Please try again.', 'liza-spotify'),
                'noResults' => __('No results found.', 'liza-spotify'),
            ],
        ]);
    }
